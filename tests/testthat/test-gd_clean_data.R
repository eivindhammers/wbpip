...
test_that("gd_clean_data() is working correctly", {
  ...
  expect_equal(
    res$welfare,
    c(
      0.02292242, 0.05774930, 0.10232770, 0.15716421, 0.22252476,
  ...
  welfare <- c(
    0.305, 0.732, 1.226, 1.77, 2.36, 2.993, 3.667, 4.379, 5.129,
  ...
  expect_equal(
    out$welfare,
    c(
      0.00305, 0.00732, 0.01226, 0.01770, 0.02360,
  ...
  expect_equal(out$welfare,
    c(
      0.01198801, 0.03196803, 0.05894106, 0.09490509, 0.14485514,
...
test_that("standardize_type5() is working correctly", {
  ...
  expect_equal(res$welfare,
    c(
      0.03190080, 0.08093525, 0.14057175, 0.21024233, 0.29023097,
